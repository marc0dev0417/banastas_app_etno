          ...
          Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: renderBackgroundImage(new_.imageUrl!), fit: BoxFit.fill)),
              child: Container(
                alignment: Alignment.bottomLeft,
                ...
                child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(new_.category!, style: const TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                              fontSize: 12.0,
                              backgroundColor: Colors.black)),
                          const SizedBox(width: 4.0),
                          Text(new_.username!, style: const TextStyle(
                              color: Colors.white,
                      ...
                      Text(new_.description!, style: const TextStyle(
...
ImageProvider renderBackgroundImage(String image) {
  if (image=='')
